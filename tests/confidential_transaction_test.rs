...
mod elements_tests {
  ...
  fn estimate_fee_test() {
    ...
    assert_eq!(548, fee_data.tx_fee);
    assert_eq!(205, fee_data.utxo_fee);
    assert_eq!(753, fee_data.utxo_fee + fee_data.tx_fee);
  ...
  fn fund_raw_transaction_test() {
    ...
    assert_eq!("",
      tx.to_str());
    ...
    let fee_data = tx
      ...
      .expect("Fail");
    assert_eq!(481, fee_data.tx_fee);
    assert_eq!(18, fee_data.utxo_fee);
    assert_eq!(499, fee_data.utxo_fee + fee_data.tx_fee);
  }
  ...
  fn fund_raw_transaction_exist_tx_in_test() {
    ...
    assert_eq!("",
      tx.to_str());
    assert_eq!(2, used_addr.len());
    if used_addr.len() == 2 {
      assert_eq!(addr2.to_str(), used_addr[0].to_str());
    ...
    let fee_data = tx
      .estimate_fee(&fee_utxos, option.fee_rate, &option)
      .expect("Fail");
    assert_eq!(871, fee_data.utxo_fee + fee_data.tx_fee);
    assert_eq!(725, fee_data.tx_fee);
    assert_eq!(146, fee_data.utxo_fee);
  }
