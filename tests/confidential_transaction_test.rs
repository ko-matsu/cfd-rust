...
mod elements_tests {
  use cfd_rust::{
    ...
    TxOutData, Txid, UtxoData,ConfidentialTxOut,
  };
  use std::str::FromStr;
  ...
  {
    let locking_script = Script::from_hex("a914001d6db698e75a5a8af771730c4ab258af30546b87").expect("Fail");
    let asset_commitment = ConfidentialAsset::from_str(
      "0bb0852f9c11249a0c8ebb1c1bc3f99c5f643fa3426d4e5c730e702aaf3f2581fc").expect("Fail");
      let value_commitment = ConfidentialValue::from_str(
      "091dd6cd19781f14385175b586607221d1f11b3f19f149e707810de78f7c7f6f79").expect("Fail");
      let nonce_commitment = ConfidentialNonce::from_str("0398e7cd1cb3c9c13506f91b946f5586cc8fa45f36dde615f2bdb48c1dfe904270").expect("Fail");
    ...
    let blinding_key = Privkey::from_str("66e4df5035a64acef16b4aa52ddc8bebd22b22c9eca150774e355abc72909d83").expect("Fail");
    let unblind_data = ConfidentialTxOut::unblind(
      &blinding_key, &locking_script, &asset_commitment, &value_commitment, &nonce_commitment, &rangeproof).expect("Fail");

    assert_eq!("5ac9f65c0efcc4775e0baec4ec03abdde22473cd3cf33c0419ca290e0751b225",
    unblind_data.asset.as_str());
    assert_eq!(209998999992700, unblind_data.amount.as_amount().as_satoshi_amount());
    assert_eq!("6b49938ded88d5c2c335133665158134041769882dd560ca47c14631052a981c",
    unblind_data.asset_blind_factor.to_hex());
    assert_eq!("0e396bcbc4c0b74329712b1b5c7f8c9c4f054996da3748b8820563f68a07dedd",
    unblind_data.amount_blind_factor.to_hex());
  }
}
